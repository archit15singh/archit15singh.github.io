---
title: "Who Am I?"
description: "My cognitive operating system: first-principles thinking, recursive refinement, and systems thinking—and how I keep evolving as a systems engineer."
...
* **Meta-Critiques**
  After drafting an architectural proposal, I’ll challenge myself: “Does this model capture the actual failure modes? Is there a simpler abstraction that communicates the same insight?” If not, I rewrite until it hits precise clarity.
...
4. **Impact**
   Those artifacts solve real problems: a reliable service workflow, a widely read article, or a mental model that reframes how a team approaches a stubborn bottleneck.
...
## 7. Additional Threads & Tendencies
